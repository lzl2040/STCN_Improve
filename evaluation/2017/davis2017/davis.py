...
class DAVIS(object):
    ...
    def __init__(self, root, task='unsupervised', subset='val', sequences='all', resolution='480p', codalab=False):
        ...
        # self.mask_path = "/root/Project/RDE/prediction/davis2017_test"
        year = '2019' if task == 'unsupervised' and (subset == 'test-dev' or subset == 'test-challenge') else '2016'
        # self.imagesets_path = os.path.join(self.root, 'ImageSets', year)
        # self.imagesets_path = "/root/autodl-tmp/datasets/DAVIS2017/trainval/ImageSets/2016"
        self.imagesets_path = "/root/autodl-tmp/datasets/DAVIS2017/trainval/ImageSets/2017"
    ...
    def _get_all_elements(self, sequence, obj_type,mode='12'):
        # import pdb
        # pdb.set_trace()
        ...
        for i, obj in enumerate(self.sequences[sequence][obj_type]):
            # 对于davis2016
            # all_objs[i, ...] = np.array(Image.open(obj)) / 255
            # 对于不是davis2016的
    ...
    def get_all_masks(self, sequence, separate_objects_masks=False):
        ...
        if separate_objects_masks:
            ...
            # print(np.arange(1, num_objects + 1))
