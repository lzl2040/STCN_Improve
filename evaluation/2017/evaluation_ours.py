...
--results_path \
mingxing/gdata1/STCN/model_66000


"""
pd.set_option('display.max_columns', None)
pd.set_option('display.max_rows', None)
default_davis_path = '/root/autodl-tmp/datasets/DAVIS2017/trainval'
# default_davis_path = '/root/autodl-tmp/datasets/DAVIS2016'
...
parser.add_argument('--results_path', type=str, help='Path to the folder containing the sequences folders',
                    required=False, default='/root/Project/STCN_QAM/prediction/davis2017_val')
...
if os.path.exists(csv_name_global_path) and os.path.exists(csv_name_per_sequence_path):
    ...
    print(args.davis_path)
    dataset_eval = DAVISEvaluation(davis_root=args.davis_path, task=args.task, gt_set=args.set, show=args.show)
    print("数据加载完成")
