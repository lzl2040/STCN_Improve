...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        # Data parameters
        parser.add_argument('--static_root', help='Static training data root',
                            default='/root/autodl-tmp/datasets/static')
        parser.add_argument('--bl_root', help='Blender training data root',
                            default='/gdata/limx/VOS/dataset/bl30k/BL30K')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='/root/autodl-tmp/datasets/YouTube')
        parser.add_argument('--davis_root', help='DAVIS data root', default='/root/autodl-tmp/datasets/DAVIS2017')

        parser.add_argument('--stage', help='Training stage (0-static images, 1-Blender dataset, 2-DAVIS+YouTubeVOS (300K), 3-DAVIS+YouTubeVOS (150K))',
                            type=int, default=0)
        ...
        # Logging information
        parser.add_argument('--id', help='Experiment UNIQUE id, use NULL to disable logging to tensorboard', default='1')
        ...
        if self.args['stage'] == 0:
            ...
            self.args['lr'] = none_or_default(self.args['lr'], 2e-5)
