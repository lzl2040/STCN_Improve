...
parser.add_argument('--model', default='saves/stage3/model_40000.pth')
parser.add_argument('--davis_path', default='/root/autodl-tmp/datasets/DAVIS2017')
parser.add_argument('--output', default='prediction/davis2017_val')
