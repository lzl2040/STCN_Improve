...
parser.add_argument('--model', default='saves//stage3_3/model_5000.pth')
parser.add_argument('--davis_path', default='/root/autodl-tmp/datasets/DAVIS2016')
parser.add_argument('--output', default='prediction/davis2016_val')
...
test_dataset = DAVISTestDataset(davis_path, imset='/root/autodl-tmp/datasets/DAVIS2017/trainval/ImageSets/2016/val.txt',
                                single_object=True)
