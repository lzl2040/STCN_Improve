...
import os
'''
CUDA_VISIBLE_DEVICES=0,1 OMP_NUM_THREADS=4 nohup python -m  torch.distributed.launch --master_port 9843  --nproc_per_node=2 train.py &
'''

'''
nohup python -m  torch.distributed.launch --master_port 9843  --nproc_per_node=2 train.py &
'''
